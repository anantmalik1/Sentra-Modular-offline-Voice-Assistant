    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/75 backdrop-blur-md p-4">
      <div className="hud-panel p-6 w-full max-w-md border-cyan-400/50 shadow-[0_0_30px_rgba(0,217,255,0.3)] bg-[#071124]/95">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="font-mono block text-xs mb-1 text-slate-300">
            ...
            <input
              ...
              className="w-full px-3 py-2 rounded-lg bg-[#0a1834] border border-cyan-400/30 focus:border-cyan-400 text-slate-100 placeholder-slate-500 text-xs font-mono focus:outline-none"
            />
          </div>

          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="font-mono block text-xs mb-1 text-slate-300 flex items-center gap-1">
              ...
              <input
                ...
                className="w-full px-3 py-2 rounded-lg bg-[#0a1834] border border-cyan-400/30 focus:border-cyan-400 text-slate-100 text-xs font-mono focus:outline-none"
              />
            </div>
            <div>
              <label className="font-mono block text-xs mb-1 text-slate-300 flex items-center gap-1">
          ...
          <div className="flex items-center justify-end space-x-3 pt-3 border-t border-cyan-500/20 mt-4">
            <button
              type="button"
              onClick={onClose}
              className="px-4 py-2 rounded-lg text-xs font-mono text-slate-300 hover:text-white bg-slate-800/80 hover:bg-slate-700 transition-colors cursor-pointer"
            >
              Cancel
            </button>
            <button
              type="submit"
              disabled={loading}
              className="flex items-center space-x-2 px-5 py-2 rounded-lg text-xs font-mono font-bold bg-cyan-950 hover:bg-cyan-900 border border-cyan-400 text-cyan-300 shadow-[0_0_15px_rgba(0,217,255,0.3)] transition-all cursor-pointer disabled:opacity-50"
            >
              <Plus size={14} />
